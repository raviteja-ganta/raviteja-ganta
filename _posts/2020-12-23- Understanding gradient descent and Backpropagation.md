...
*a<sub>j</sub><sup>[l]</sup>* = <img src="https://render.githubusercontent.com/render/math?math=\Huge f">(<img src="https://render.githubusercontent.com/render/math?math=\displaystyle \sum_{k}"> 
