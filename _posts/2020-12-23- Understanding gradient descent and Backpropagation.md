...
<img src="https://render.githubusercontent.com/render/math?math=\LARGE C = f(y^i,yhat)"> where <img src="https://render.githubusercontent.com/render/math?math=\LARGE y^i"> is the actual label or truth of data point *i*
